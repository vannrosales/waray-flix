  ...
  return (
    <div className={`flex items-center gap-2 flex-shrink-0 ${className}`}>
      ...
      <select
        ...
        className="bg-[#18181C] hover:bg-[#222228] text-white text-xs font-medium rounded-full px-3 py-1 border border-white/[0.08] outline-none cursor-pointer transition shadow-xs"
      >
        {options.map((opt) => (
