...
import { Play, Star, Clock, Bookmark, Layers, QrCode, ArrowRight, Users2, Film, Tv } from 'lucide-react';
      ...
      <div className="flex-1 space-y-5 pt-4 sm:pt-8">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-3 text-xs text-zinc-400">
            <span className="px-2.5 py-0.5 rounded bg-white text-black font-bold uppercase text-[10px] shadow-sm">
              {type}
            </span>
        ...
        {watchProgress && totalSeconds > 0 && (
          <div className="space-y-1.5 max-w-md p-3.5 rounded-xl bg-[#18181C] border border-white/[0.08] shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-1">
          <button 
            onClick={onPlayClick}
            className="px-7 py-2.5 rounded-xl bg-white hover:bg-zinc-200 text-black font-semibold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition cursor-pointer shadow-md hover:shadow-lg hover:scale-105"
          >
          ...
          {onOpenCast && (
            <button 
              ...
              title="Cast to Smart TV or Chromecast"
            >
          ...
          <button 
            onClick={onOpenParty}
            className="px-4 py-2.5 rounded-xl border border-white/10 bg-white/[0.06] text-zinc-300 hover:text-white hover:bg-white/[0.12] text-xs font-medium uppercase tracking-wider flex items-center gap-2 transition cursor-pointer backdrop-blur-md shadow-sm"
        ...
        {media.belongs_to_collection && (
          <div 
            ...
            className="flex items-center justify-between p-4 rounded-none bg-[#121212] hover:bg-[#222228] border border-white/[0.08] hover:border-white/30 transition cursor-pointer group shadow-sm hover:shadow-md"
          >
